@def title = "Gridap.jl for Hydraulic and Offshore Engineers"
@def tags = ["syntax", "code"]
@def mintoclevel=1
@def maxtoclevel=1

This is a library of tutorials made for and by Hydraulic and Offshore Engineering students at [**Delft University of Technology**](www.tudelft.nl). The goal of this library is two fold: to give visibility to the work of MSc students and to serve as guidance of new MSc thesis.
...
# Tutorials by topic
## Floating structures
- [~~~<b>Very Flexible Floating Structures (VFFS)</b>~~~](/FSI/VFFS/VFFS) by Sjoerd van Hoof
...
- [~~~<b>Very Large Floating Structures (VLFS)</b>~~~](/FSI/VLFS/VLFS) by Dorette Regout
